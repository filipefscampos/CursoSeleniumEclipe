...
public class DSL {
	...
	public void clicarBotaoTabela(String colunaBusca, String valor, String colunaBotao, String idTabela) {
		...
		//posso continuar a busca pelo elemento de dentro da tabela, usando o . para referenciar o diretorio corrente
		int idColuna = obterIndiceColuna(colunaBusca, tabela);
		
		//linha do registro
		//.//*[@id='elementosForm:tableUsuarios']//tr/td[1]
		...
		//clicar no botão
		//.//*[@id='elementosForm:tableUsuarios']//tr[2]/td[3]
		WebElement celula = tabela.findElement(By.xpath(".//tr["+idLinha+"]/td["+idColunaBotao+"]"));
		celula.findElement(By.xpath(".//input")).click();
		
		//*[@id='elementosForm:tableUsuarios']/tbody/tr/td[1]
	}
